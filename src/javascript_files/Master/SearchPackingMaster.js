...
function SearchPackingMaster({
  ...
  function handleSearch(e) {
    e.preventDefault();
    const url = `${process.env.REACT_APP_API_URL}/api/v1/Packing/GetPackingByIdAndName?id=${searchData.Id}&name=${searchData.Name}`;
    axios
      .get(url, {
        headers: {
  ...
  return (
    <form className="search-packing-master-form" onSubmit={handleSearch}>
