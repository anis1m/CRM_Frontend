...
function SearchCategoryMaster({
  ...
  function handleSearch(e) {
    ...
    const url = `${process.env.REACT_APP_API_URL}/api/v1/Category/GetCategoryByIdOrName?id=${searchData.Id}&name=${searchData.Name}`;
    axios
      .get(url, {
        headers: {
  ...
  return (
    <form className="search-category-master-form" onSubmit={handleSearch}>
